...
import { DocumentObjectComponent } from 'app/entities/document-object/document-object.component';
...
describe('Component Tests', () => {
  describe('DocumentObject Management Component', () => {
    let comp: DocumentObjectComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DocumentObjectComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.documentObjects && comp.documentObjects[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
