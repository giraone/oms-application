...
/**
 * Spring Data SQL repository for the DocumentObject entity.
 */
...
public interface DocumentObjectRepository extends JpaRepository<DocumentObject, Long> {
    ...
    @Query(
        "select documentObject from DocumentObject documentObject where documentObject.owner.id = ?1 or documentObject.documentPolicy = 'PUBLIC'"
    )
