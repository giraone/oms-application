...
public class DocumentAccessEntryResource {
    ...
    public ResponseEntity<DocumentAccessEntryDTO> createDocumentAccessEntry(@Valid @RequestBody DocumentAccessEntryDTO documentAccessEntryDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/document-access-entries/" + result.getId()))
    ...
    public ResponseEntity<DocumentAccessEntryDTO> updateDocumentAccessEntry(@Valid @RequestBody DocumentAccessEntryDTO documentAccessEntryDTO) throws URISyntaxException {
