...
import { EntityArrayResponseType, DocumentObjectService } from '../service/document-object.service';
...
export class DocumentObjectComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDocumentObject): number => this.documentObjectService.getDocumentObjectIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.documentObjects = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDocumentObject[] | null): IDocumentObject[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.documentObjectService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
